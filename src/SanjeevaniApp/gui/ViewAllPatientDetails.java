...
public class ViewAllPatientDetails extends javax.swing.JFrame {
        ...
        public void showPatientData()
    {
              try
        {
            ArrayList <PatientPojo> patientList = PatientDao.getAllViewPatientDetails();
    ...
    private void initComponents() {
        ...
        btnpatientframe = new javax.swing.JButton();
        ...
        btnpatientframe.setText("Home");
        btnpatientframe.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnpatientframeActionPerformed(evt);
            }
        });
        ...
        jtEmpData.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "P_ID", "F_NAME", "S_NAME", "AGE", "OPD", "GENDER", "M_STATUS", "P_DATE", "ADDRESS", "CITY", "PHONE_NO", "DOCTOR_ID", "WARDNO", "BEDNO"
            }
        ) {
...
private void closeFrame(){
    ...
    private void btnpatientframeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnpatientframeActionPerformed
          ViewPatientFrame mef = new ViewPatientFrame();
        mef.setVisible(true);
        this.dispose();
    }//GEN-LAST:event_btnpatientframeActionPerformed
    ...
    private javax.swing.JButton btnpatientframe;
