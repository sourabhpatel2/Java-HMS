...
public class ViewReceptionistFrame extends javax.swing.JFrame {
    ...
    /**
     * Creates new form ViewReceiptionistFrame
     */
    public ViewReceptionistFrame() {
        initComponents();
         setLocationRelativeTo(null);
        Toolkit t=Toolkit.getDefaultToolkit();
        Image icon=t.getImage("C:\\Users\\Vision\\Desktop\\NOTES\\Campus\\java notes\\CORE_JAVA\\hms.png");
    ...
    public void showReceptionistData()
    {
              try
        {
            ArrayList <UserDetails> receptionistList = ReceptionistDao.getAllReceptionist();
            Object row[] = new Object[4];
            DefaultTableModel dtm = (DefaultTableModel)jtEmpData.getModel();
            for(UserDetails u: receptionistList)
            {
                row[0] = u.getUserid();
                row[1] = u.getUserName();
                row[2] = u.getEmpId();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("View Receiptionist");
